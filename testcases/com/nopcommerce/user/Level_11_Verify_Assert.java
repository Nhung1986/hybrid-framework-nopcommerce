...
public class Level_11_Verify_Assert extends BaseTest{
	...
	public void User_01_Register() {
		...
		System.out.println("text " + registerPage.getSuccessMessageAtRegister());
		verifyEquals(registerPage.getSuccessMessageAtRegister(), "Your registration completed");
	}
